...
class ExchangeClient {
  ...
  parseCurrency(pair) {
    ...
    if (currency && baseCurrency) {
      return {
        baseCurrency: potentialBaseCurrencies.includes(baseCurrency) ? baseCurrency : currency,
        currency: potentialBaseCurrencies.includes(baseCurrency) ? currency : baseCurrency
      }
    }
